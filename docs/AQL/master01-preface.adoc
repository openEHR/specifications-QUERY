...
Issues may be raised on the {openehr_jira_prs_query}[specifications Problem Report tracker].

To see changes made due to previously reported issues, see the {openehr_jira_crs_query}[{component} component Change Request tracker].
