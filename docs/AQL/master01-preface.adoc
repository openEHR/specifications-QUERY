...
This specification is in the {spec_status} state. The latest development version of this document can be found at {openehr_query_aql}.
...
The text of this specification was originally posted on the https://openehr.atlassian.net/wiki/spaces/spec/pages/4915203/AQL-+Archetype+Query+Language[openEHR wiki], and was used by the global openEHR community in that form.
