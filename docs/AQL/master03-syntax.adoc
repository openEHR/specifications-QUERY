...
Aggregate functions calculate a single result value from a set of _input values_, aggregated from the result set using an _expression_, representing an <<_aql_identified_paths, identified path>>.
