...
NOTE: The AQL specification is not binded to a specific Reference Model, but to use a
certain RM, it should comply with some requirements: it should be an Object Oriented
