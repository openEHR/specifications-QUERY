...
A column expression is formed by an <<_identified_paths,identified path>>, a <<_functions,function>> or plain <<_variables,variable>> name defined in the `FROM` clause.
