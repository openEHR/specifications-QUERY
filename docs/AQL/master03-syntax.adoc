...
A column expression is formed by an <<_aql_identified_paths,identified path(s)>>, a <<_functions,function>> or plain <<_aql_variables,variable>> name defined in the `FROM` clause.
